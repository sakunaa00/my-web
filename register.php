...
<head>
    ...
    <style>
        ...
        body { position: relative; overflow: hidden; background: pink; font-family: system-ui, Arial, sans-serif; color: #3a0320; }
...
<body>
    <div class="container">
        ...
        <p>Register to join us. Your page keeps the falling hearts.</p>
